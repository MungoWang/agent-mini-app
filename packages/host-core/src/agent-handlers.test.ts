...
import { listAgentTools, createAgentHandlers } from "./agent-handlers.js";
import type { RuntimePort, AppTab } from "./ports.js";
...
describe("agent-core", () => {
  ...
  it("validate rejects bad appId", async () => {
    ...
    const r = (await h.mini_app_validate({ appId: "NotValid" })) as { ok: boolean };
