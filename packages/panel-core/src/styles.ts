/** 面板样式（注入式，机制对齐 dsh 官方 data-plugin-css）。
 *  宿主挂载时调 injectPanelCss() 一次性注入 <style data-plugin-css="panel-core">。
 *  跨项目复用：无需改样式，class 前缀 mma- 语义化。 */
export const PANEL_CSS_TAG = "panel-core"
...
const CSS = [
  ...
  "#mma-host .mma-settings-actions{display:flex;align-items:center;gap:10px;margin-top:18px;}",
  ...
  "#mma-host .mma-bitem b{font-size:13px;display:block;margin-bottom:4px;}",
  "#mma-host .mma-bitem .meta{display:flex;gap:10px;font-size:11px;opacity:.65;flex-wrap:wrap;}",
  "#mma-host .mma-bitem .mma-plus{color:#16a34a;}",
  "#mma-host .mma-bitem .mma-minus{color:#dc2626;}",
  "#mma-host .mma-fitem{display:flex;align-items:center;gap:8px;width:100%;padding:6px 8px;border:0;background:transparent;cursor:pointer;font-size:12px;color:inherit;}",
  "#mma-host .mma-fitem:hover{background:var(--dsw-alias-muted,#f3f4f6);}",
  "#mma-host .mma-fitem .p{flex:1;font-family:ui-monospace,monospace;}",
  "#mma-host .mma-preview{margin:4px 0 8px 24px;padding:10px;background:var(--dsw-alias-muted,#f3f4f6);border-radius:8px;font-size:11px;max-height:220px;overflow:auto;white-space:pre;line-height:1.5;}",
...
export function injectPanelCss(): void {
  if (typeof document === "undefined" || document.querySelector(`style[data-plugin-css="${PANEL_CSS_TAG}"]`)) return
  const tag = document.createElement("style")
  tag.dataset.plugin = "panel-core"
