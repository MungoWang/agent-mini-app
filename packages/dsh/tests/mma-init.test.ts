...
import { ensureHostConfig, parseHostConfig } from "@monkey-mini-app/host";
...
describe("ensureHostConfig", () => {
  it("writes a complete host.json via bootstrap and does not clobber a valid file", () => {
    ...
    const first = ensureHostConfig({ runtimeRoot: dir, hostPort: 19111 });
    ...
    const second = ensureHostConfig({ runtimeRoot: dir, hostPort: 0 });
