...
Agent instructions live in `skills/monkey-mini-app/SKILL.md` (also published via `@monkey-mini-app/agent-skills`). Prefer loading that skill over reading runtime source.
...
```yaml
- id: monkey-mini-app
  name: "@monkey-mini-app/dsh-plugin"
  config:
