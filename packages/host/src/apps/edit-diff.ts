/**
 * Text-edit applicator adapted from Pi coding-agent edit-diff.ts
 * (https://github.com/badlogic/pi-mono, MIT License).
 * Fuzzy unique oldText→newText matching for agent file edits.
 */
