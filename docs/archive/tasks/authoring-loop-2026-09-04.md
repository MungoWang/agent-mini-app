# 任务归档：小程序作者闭环（静态检查 + 运行时回流）

> 归档日期：2026-09-05 · 任务来源：2026-09-04 dsh 实测反馈 · 原位置：`TODO.md`
> 状态：**已完成**（P0-1/P0-2/P0-3/P1-4/P1-6/P1-7/P2-8/P2-9 落地并实测）。
> P1-5（动画）转入 `docs/rfcs/authoring-surface.md`；P2-10、P3 当时决定推迟，结论见文末。
> 归档内容不是实现依据（AGENTS.md → docs/archive 规则）。
