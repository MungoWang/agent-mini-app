...
export default function Ui() {
  ...
  // ⭐ key: refresh depends on filter and re-fetches when it changes; useCallback avoids an infinite loop
  ...
  return (
    // ⭐ key: one fixed screen — AppShell sets the height, main scrolls internally, the page never scrolls as a whole.
    //         Keeps content from being squeezed into a slit + still fills the frame after the sidebar collapses or docks right.
