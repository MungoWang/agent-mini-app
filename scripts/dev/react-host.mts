/**
 * One-command react-host dev: boot the demo host (scripts/dev/demo-templates.mts) then
 * vite react-host. Usage: `pnpm dev:host [hostPort]` (host default 17900).
 * Ctrl-C / exit tears down the demo host too.
 *
 * Inputs:       argv[1] host port (default 17900); Vite on 5174
 * Writes:       temp runtime dirs for the demo host
 * Side effects: starts two local processes and holds ports
 * Run as:       pnpm dev:host
 */
...
async function main(): Promise<void> {
  host = spawnPkg(["tsx", "scripts/dev/demo-templates.mts", String(HOST_PORT)], root);
