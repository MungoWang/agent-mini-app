 ...
 * Inputs:       packages/ui/src/**, packages/ui/package.json, node_modules (esbuild metafile)
 * Writes:       packages/ui/dist/{index.js,src/**,vendor/**,globals.css,manifest.json}
 * Side effects: repo build output (gitignored)
 * Run as:       pnpm build:ui — also `prepack` of @monkey-mini-app/ui
 */
