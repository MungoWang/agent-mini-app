 ...
 *
 * Inputs:       the scene slug list in this file + raw.githubusercontent.com (unDraw SVGs)
 * Writes:       packages/ui/src/lib/illustrations.tsx
 * Side effects: repo tracked source
 * Run as:       manual — only when changing the illustration set; never in the publish pipeline
 */
...
const lines = [
  ...
  " * Regenerate: node scripts/gen/illustrations.mjs",
  " */",
